...
[图 D-1](#Fig1) 提供了使用 SDM 的图像纹理的可视化。

![9781430259299_AppD-01.jpg](img/images/9781430259299_AppD-01.jpg)

[图 D-1](#_Fig1) 。SDM 扩展指标

[清单 D-1](#list1) 展示了来自[第 3 章](03.html)的扩展 SDM 指标。该准则可在网站上获得

`http://www.apress.com/source-code/ComputerVisionMetrics`

[***清单 D-1。***](#_list1) 延伸 SDM 度量从[第三章](03.html)
