...
![img/493065_1_En_5_Fig1_HTML.jpg](img/493065_1_En_5_Fig1_HTML.jpg)
...
![img/493065_1_En_5_Fig2_HTML.jpg](img/493065_1_En_5_Fig2_HTML.jpg)
...
![img/493065_1_En_5_Fig3_HTML.jpg](img/493065_1_En_5_Fig3_HTML.jpg)
...
![img/493065_1_En_5_Fig4_HTML.png](img/493065_1_En_5_Fig4_HTML.png)
...
![$$ \boldsymbol{f}\left(\boldsymbol{x}\right)=\boldsymbol{w}\boldsymbol{1}\boldsymbol{x}\boldsymbol{1}+\boldsymbol{w}\boldsymbol{2}\boldsymbol{x}\boldsymbol{2}+\boldsymbol{w}\boldsymbol{3}\boldsymbol{x}\boldsymbol{3}+\dots +\boldsymbol{w}\boldsymbol{nxn} $$](img/493065_1_En_5_Chapter_TeX_Equ1.png)

(等式 5-1)

有时一个偏差 x <sub>0</sub> 也被加到方程中，如下所示:

![$$ \boldsymbol{f}\left(\boldsymbol{x}\right)=\boldsymbol{x}\boldsymbol{0}+\boldsymbol{w}\boldsymbol{1}\boldsymbol{x}\boldsymbol{1}+\boldsymbol{w}\boldsymbol{2}\boldsymbol{x}\boldsymbol{2}+\boldsymbol{w}\boldsymbol{3}\boldsymbol{x}\boldsymbol{3}+\dots +\boldsymbol{w}\boldsymbol{nxn} $$](img/493065_1_En_5_Chapter_TeX_Equ2.png)

(方程 5-2)

方程式 5-2 也可以写成:

![$$ {\displaystyle \begin{array}{c}i=\mathrm{n}\\ {}\mathrm{f}\left(\mathrm{x}\right)={\mathrm{X}}_0+\left[?\right]\left[?\right]\left[?\right]{\mathrm{W}}_{\mathrm{i}}{\mathrm{X}}_{\mathrm{i}}\\ {}i=1\end{array}} $$](img/493065_1_En_5_Chapter_TeX_Equ3.png)
...
![img/493065_1_En_5_Fig5_HTML.png](img/493065_1_En_5_Fig5_HTML.png)
...
![$$ \boldsymbol{f}\left(\boldsymbol{x}\right)=\boldsymbol{x}\boldsymbol{0}+\boldsymbol{w}\boldsymbol{1}\boldsymbol{x}\boldsymbol{1} $$](img/493065_1_En_5_Chapter_TeX_Equa.png)
...
一个多层感知器至少由三类层组成:输入层、隐藏层、输出层(如图 [5-5](#Fig5) )。您可以有多个隐藏层。每层包含一个或多个神经元。神经元对它获得的输入进行一些计算，并产生输出。神经元的输出作为输入发送到下一层，但输出层除外，它生成最终输出供应用使用。

MLP 体系结构包括以下内容:

![img/493065_1_En_5_Fig6_HTML.png](img/493065_1_En_5_Fig6_HTML.png)
...
![$$ \mathrm{z}={\mathrm{X}}_0+\sum \limits_{i=0}^{i=n}{w}_i{x}_i $$](img/493065_1_En_5_Chapter_TeX_Equ4.png)
...
有几个数学函数被用作不同用途的激活。我们将探索 TensorFlow 开箱即用支持的以下激活功能。我们将在下一节学习更多关于TensorFlow的知识。

#### 线性激活函数

线性激活函数根据等式 **f(x) = x0+ w1x1 + w2x2 + w3x3 +通过将权重乘以输入来计算神经元输出....+ wnxn** 。线性激活函数的输出从-∞到+∞，如图 [5-7](#Fig7) 所示。这意味着线性激活函数和没有激活一样好。

![img/493065_1_En_5_Fig7_HTML.jpg](img/493065_1_En_5_Fig7_HTML.jpg)
...
![$$ \sigma \left(\mathrm{z}\right)=1/\left(1+{e}^{-\mathrm{Z}}\right) $$](img/493065_1_En_5_Chapter_TeX_Equ5.png)
...
![img/493065_1_En_5_Fig8_HTML.jpg](img/493065_1_En_5_Fig8_HTML.jpg)
...
![img/493065_1_En_5_Fig9_HTML.jpg](img/493065_1_En_5_Fig9_HTML.jpg)
...
![$$ \tanh \left(\mathrm{z}\right)=\left({e}^{\mathrm{z}}-{e}^{-\mathrm{z}}\right)/\left({e}^{\mathrm{z}}+{e}^{-\mathrm{z}}\right) $$](img/493065_1_En_5_Chapter_TeX_Equ6.png)
...
![$$ f(z)=\max \left(0,z\right) $$](img/493065_1_En_5_Chapter_TeX_Equ7.png)

(等式 5-7)

![img/493065_1_En_5_Fig10_HTML.jpg](img/493065_1_En_5_Fig10_HTML.jpg)
...
![img/493065_1_En_5_Fig11_HTML.jpg](img/493065_1_En_5_Fig11_HTML.jpg)
...
![$$ f\left(\alpha, x\right)=\uplambda\;\left\{\begin{array}{l}\alpha \left({e}^x-1\right)\;\mathrm{for}\;x&lt;0\\ {}x\kern2.04em \mathrm{for}\;x\ge 0\end{array}\right. $$](img/493065_1_En_5_Chapter_TeX_Equ8.png)
...
![img/493065_1_En_5_Fig12_HTML.jpg](img/493065_1_En_5_Fig12_HTML.jpg)
...
![$$ f(x)=\ln \left(1+{e}^z\right) $$](img/493065_1_En_5_Chapter_TeX_Equ9.png)

(等式 5-9)

Softplus 也称为 SmoothReLU 函数。softplus 函数的一阶导数为 1/(1+e <sup>-z</sup> ，与 sigmoid 激活函数相同。见图 [5-13](#Fig13) 。

![img/493065_1_En_5_Fig13_HTML.jpg](img/493065_1_En_5_Fig13_HTML.jpg)
...
![$$ \sigma {\left(\mathrm{z}\right)}_i=\frac{e^{z_i}}{\sum_{j=1}^K{e}^{z_j}}\;\mathrm{for}\;i=1,\dots, K\; and\;\mathrm{z}=\left({z}_1,\cdots, {z}_K\right)\in {\mathrm{\mathbb{R}}}^K $$](img/493065_1_En_5_Chapter_TeX_Equ10.png)
...
*TensorFlow示例* : `model.compile(loss='mean_squared_error') or model.compile(loss='mse')`
...
*TensorFlow示例* : `model.compile(loss='mean_squared_logarithmic_error')`
...
*TensorFlow示例* : `model.compile(loss='mean_absolute_error')`
...
*TensorFlow示例* : `model.compile(loss='binary_crossentropy', metrics=['accuracy'])`
...
*TensorFlow示例* : `model.compile(loss='hinge', metrics=['accuracy'])`
...
*TensorFlow示例* : `model.compile(loss='squared_hinge', metrics=['accuracy'])`
...
*TensorFlow示例* : `model.compile(loss='categorical_crossentropy', metrics=['accuracy'])`
...
*TensorFlow示例* : `model.compile(loss='sparse_categorical_crossentropy', metrics=['accuracy'])`
...
*TensorFlow示例* : `model.compile(loss='kullback_leibler_divergence', metrics=['accuracy'])`
...
![$$ f(w)=\frac{1}{N}\sum \left({y}_i-{w}_i{x}_i\right) $$](img/493065_1_En_5_Chapter_TeX_Equ11.png)
...
![img/493065_1_En_5_Fig14_HTML.jpg](img/493065_1_En_5_Fig14_HTML.jpg)
...
![$$ \boldsymbol{weight}=\boldsymbol{weight}+\boldsymbol{alpha}\ast \left(\hbox{-} \boldsymbol{delta}\right)=\boldsymbol{weight}\hbox{-} \boldsymbol{alpha}\ast \boldsymbol{delta} $$](img/493065_1_En_5_Chapter_TeX_Equ12.png)
...
![img/493065_1_En_5_Fig15_HTML.jpg](img/493065_1_En_5_Fig15_HTML.jpg)
...
![img/493065_1_En_5_Fig16_HTML.png](img/493065_1_En_5_Fig16_HTML.png)
...
![$$ v= yv+\mathrm{alpha}\ast \mathrm{delta} $$](img/493065_1_En_5_Chapter_TeX_Equ13.png)
...
![$$ \boldsymbol{weight}=\boldsymbol{weight}+\boldsymbol{v} $$](img/493065_1_En_5_Chapter_TeX_Equb.png)
...
在下面几节中，我们将编写代码来实现本章前面几节中涉及的一些概念。我们将编写 Python 代码并使用 TensorFlow 来完成示例。我们将从 TensorFlow 的高级介绍开始，涵盖与计算机视觉相关的特性和功能。我们将在本章的剩余部分使用TensorFlow代码，我们将在实现神经网络概念时提供相关的解释。
...
在我们深入研究神经网络之前，让我们理解TensorFlow的一些术语。
...
这本书不是关于TensorFlow的。我们将只涵盖与编写构建计算机视觉和深度学习模型的代码相关的功能。您应该访问 TensorFlow 官方网站，并学习使用 TensorFlow 的 Python 函数。下面是 API 规范: [`https://www.tensorflow.org/api_docs/python/tf`](https://www.tensorflow.org/api_docs/python/tf) 。

我们将在接下来的几乎所有章节中重新讨论TensorFlow。
...
![img/493065_1_En_5_Fig17_HTML.jpg](img/493065_1_En_5_Fig17_HTML.jpg)
...
![img/493065_1_En_5_Fig18_HTML.jpg](img/493065_1_En_5_Fig18_HTML.jpg)
...
![img/493065_1_En_5_Fig19_HTML.png](img/493065_1_En_5_Fig19_HTML.png)
...
![img/493065_1_En_5_Fig20_HTML.png](img/493065_1_En_5_Fig20_HTML.png)
...
![img/493065_1_En_5_Fig21_HTML.jpg](img/493065_1_En_5_Fig21_HTML.jpg)
...
![img/493065_1_En_5_Fig22_HTML.png](img/493065_1_En_5_Fig22_HTML.png)
...
![img/493065_1_En_5_Fig23_HTML.jpg](img/493065_1_En_5_Fig23_HTML.jpg)
...
![img/493065_1_En_5_Fig24_HTML.jpg](img/493065_1_En_5_Fig24_HTML.jpg)
...
![img/493065_1_En_5_Fig26_HTML.jpg](img/493065_1_En_5_Fig26_HTML.jpg)

图 5-26

历元=2 的模型评估

![img/493065_1_En_5_Fig25_HTML.jpg](img/493065_1_En_5_Fig25_HTML.jpg)
...
![img/493065_1_En_5_Fig27_HTML.png](img/493065_1_En_5_Fig27_HTML.png)
...
![img/493065_1_En_5_Fig28_HTML.jpg](img/493065_1_En_5_Fig28_HTML.jpg)
...
![img/493065_1_En_5_Fig30_HTML.jpg](img/493065_1_En_5_Fig30_HTML.jpg)

图 5-30

作为一堆 2D 矩阵的三通道彩色图像的张量表示

![img/493065_1_En_5_Fig29_HTML.jpg](img/493065_1_En_5_Fig29_HTML.jpg)
...
![img/493065_1_En_5_Fig31_HTML.jpg](img/493065_1_En_5_Fig31_HTML.jpg)
...
![img/493065_1_En_5_Fig32_HTML.jpg](img/493065_1_En_5_Fig32_HTML.jpg)
...
![img/493065_1_En_5_Fig33_HTML.png](img/493065_1_En_5_Fig33_HTML.png)
...
![img/493065_1_En_5_Fig34_HTML.jpg](img/493065_1_En_5_Fig34_HTML.jpg)
...
![img/493065_1_En_5_Fig36_HTML.jpg](img/493065_1_En_5_Fig36_HTML.jpg)

图 5-36

用于训练和评估的度量标准(一个时期内的损失和准确性)的样本图

![img/493065_1_En_5_Fig35_HTML.png](img/493065_1_En_5_Fig35_HTML.png)
...
![img/493065_1_En_5_Fig37_HTML.jpg](img/493065_1_En_5_Fig37_HTML.jpg)
...
![img/493065_1_En_5_Fig38_HTML.jpg](img/493065_1_En_5_Fig38_HTML.jpg)
...
![img/493065_1_En_5_Fig39_HTML.jpg](img/493065_1_En_5_Fig39_HTML.jpg)
...
![img/493065_1_En_5_Fig40_HTML.jpg](img/493065_1_En_5_Fig40_HTML.jpg)
