...
这本书不是关于 TensorFlow 的。我们将只涵盖与编写构建计算机视觉和深度学习模型的代码相关的功能。您应该访问 TensorFlow 官方网站，并学习使用 TensorFlow 的 Python 函数。下面是 API 规范: [`https://www.tensorflow.org/api_docs/python/tf`](https://www.tensorflow.org/api_docs/python/tf) 。
