...
与大多数传统的识别应用类似，图像识别可能会遵循一些预定义的步骤，从接受输入到返回所需的结果。这些步骤的总结如图 [1-1](#Fig1) 所示。
...
![$$ Z=\sqrt{X^2+{Y}^2} $$](img/473634_1_En_1_Chapter_TeX_IEq1.png)(方程式 1-1)

![$$ Angle= ta{n}^{-1}\frac{Y}{X} $$](img/473634_1_En_1_Chapter_TeX_IEq2.png)(方程式 1-2)

梯度幅度等于![$$ \sqrt{15^2+{10}^2}=18.03\. $$](img/473634_1_En_1_Chapter_TeX_IEq3.png)
