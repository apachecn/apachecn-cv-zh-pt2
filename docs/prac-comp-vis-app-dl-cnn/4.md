...
<colgroup><col class="tcol1 align-left"> <col class="tcol2 align-left"></colgroup> 
| ![$$ {\displaystyle \begin{array}{l}\mathit{\operatorname{Max}}\ Y\\ {}\mathit{\operatorname{Min}}\ K\end{array}}\Big\} $$](img/473634_1_En_4_Chapter_TeX_IEq1.png)在哪里***Y***=***Z***<sup>3</sup>—***X***—2)<sup>2</sup>+3***K***=(***X***2)<sup>2</sup>+1 使遭受 1≤t0**≤3&【1≤T4】**【z】**≤2** | (方程式 4-4) |
